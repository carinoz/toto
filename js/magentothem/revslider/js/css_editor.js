...
var UniteCssEditorRev = new function(){
	...
	var deleteStylesInDb = function(handle, id){
		...
		// });
		 ...
		 var ajax_url = jQuery('#caption_url').val();
		  new Ajax.Request(ajax_url, {
				 parameters: {mydata:handle,delete_action:1},
				 method:'post',
				 requestHeaders: {Accept: 'application/json'},
				 onSuccess: function(transport) {

					updateCaptionsInput(transport.responseJSON.arrCaptions);
				  }
